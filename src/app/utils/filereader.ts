...
import { ApiVersion, orchestratedKey, RequestOperation } from "../models/handler"
import { orchestrationState } from "../store/orchestration/orchestration-state"

export const filereader = async (params: string[], mockUsername: string, operation: RequestOperation, version: ApiVersion): Promise<JsonResponse> => {
  try {
